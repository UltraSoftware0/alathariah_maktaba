				...
				<div class="header-search-nav">
					<div class="header-item-search">
						<div class="input-group search-input">
							...
							<input type="text" class="form-control" aria-label="Text input with dropdown button" placeholder="ابحث عن كتب">
				...
				<div class="container clearfix">
					...
					<div class="extra-nav">
						<div class="extra-cell">
							<a href="contact-us.html" class="btn btn-primary btnhover">تسجيل</a>
						</div>
					</div>
		...
		<div class="main-slider style-1">
			<div class="main-swiper">
                <div class="swiper-wrapper">
					<div class="swiper-slide bg-white" style="background-image: url(images/background/waveElement.png);">
						<div class="container">
									...
									<div class="col-md-6">
										<div class="swiper-content">
											<div class="content-info">
												<h6 class="" data-swiper-parallax="-10">مكتبة تؤسس للمعرفة والإلهام وتنمي القراءة </h6>
												<h1 class="mb-0" data-swiper-parallax="-20">نحو ثقافة تأصيلية</h1>

												<p class="ml-1" data-swiper-parallax="-40" style="padding-left: 20% !important;">تهدف "المكتبة الأثرية" إلى تطوير فهم وتقدير عميق للتقاليد والتراث، وبناء أسس قوية للتبادل والتفاعل. يعكس هذا العنوان التزامنا بتعزيز التنوع وتعزيز حب القراءة والمعرفة.</p>
											</div>
{{--
										</div>
									</div>
...
{{--											</div>--}}
									...
									<div class="col-md-6">
										<div class="banner-media" data-swiper-parallax="-100">
											<img src="{{asset('frontend/images/banner/book4-no-background.webp')}}" alt="banner-media1">
										</div>
{{--										<img class="pattern" src="{{asset('frontend/images/Group.png')}}" data-swiper-parallax="-100" alt="dots">--}}
									</div>
							...
							<div class="banner-content">
								<div class="row">
									<div class="col-md-6">
										<div class="swiper-content">
											<div class="content-info">
												<h6 class="" data-swiper-parallax="-10">مكتبة إلكترونية لتطوير مهارات القراءة وتحميل الكتب بسهولة ويسر </h6>
												<h1 class="mb-0" data-swiper-parallax="-20">تلخيص وتمكين</h1>

												<p class="ml-1" data-swiper-parallax="-40" style="padding-left: 20% !important;">تطوير مهارات القراءة وزيادة المعرفة من خلال ملخصات الكتب المفيدة والمفعمة بالحيوية والإلهام.</p>
											</div>
{{--
										</div>
									</div>
...
{{--											</div>--}}
									...
									<div class="col-md-6">
										<div class="banner-media" data-swiper-parallax="-100">
											<img src="{{asset('frontend/images/banner/book6-no-background.webp')}}" alt="banner-media1">
										</div>
{{--										<img class="pattern" src="{{asset('frontend/images/Group.png')}}" data-swiper-parallax="-100" alt="dots">--}}
									</div>
									...
									<div class="col-md-6">
										<div class="swiper-content">
											<div class="content-info">
												...
												<p class="ml-1" data-swiper-parallax="-40" style="padding-left: 20% !important;">شرح شرح شرح شرح شرح شرح شرح شرح شرح شرح شرح شرح شرح شرح شرح شرح شرح شرح شرح شرح شرح شرح شرح شرح شرح شرح شرح شرح شرح شرح شرح شرح شرح شرح شرح شرح شرح </p>
											</div>
{{--
										</div>
									</div>
...
{{--											</div>--}}
									...
									<div class="col-md-6">
										<div class="banner-media" data-swiper-parallax="-100">
											<img src="{{asset('frontend/images/banner/book7-no-background.webp')}}" alt="banner-media1">
										</div>
{{--										<img class="pattern" src="{{asset('frontend/images/Group.png')}}" data-swiper-parallax="-100" alt="dots">--}}
									</div>
							...
							<div class="books-card style-1 wow fadeInUp" data-wow-delay="0.1s">
								...
								<div class="dz-content">
                                    <div class="row">
                                        ...
                                        <p class="ml-1">
                                            يعد كتاب الرسالة للشافعي من أهم المؤلفات في الفقه الإسلامي، ويشتمل على بيانات مبسطة ومهمة.
                                        </p>
                                        <span class="price">للأمام الشافعي</span>
                                    </div>
									<a href="#" class="btn btn-secondary btnhover2"><i class="fa fa-download m-r10" style="padding-left: 10% !important;"></i> تحميل</a>
								</div>
							</div>
						</div>
						<div class="swiper-slide">
					...
					<div class="swiper-wrapper">
						<div class="swiper-slide">
							<div class="dz-blog style-1 bg-white m-b30 wow fadeInUp" data-wow-delay="0.1s" >
								<div class="dz-media">
									<a href="blog-detail.html"><img src="{{assert('frontend/images/blog/grid/blog4.jpg')}}" alt="/"></a>
								</div>
